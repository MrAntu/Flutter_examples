...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../localPod/flutter_lib/frameworks/Flutter.framework"
  install_framework "${PODS_ROOT}/../localPod/flutter_lib/frameworks/url_launcher.framework"
fi
