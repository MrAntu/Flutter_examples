...
//  CustomLocalizations(this.locale);
  ...
  // 静态私有成员，没有初始化
  static CustomLocalizations _instance;

  // 单例公开访问点
  factory CustomLocalizations() => _sharedInstance();

  // 私有构造函数
  CustomLocalizations._() {
    // 具体初始化代码
  }

  // 静态、同步、私有访问点
  static CustomLocalizations _sharedInstance() {
    if (_instance == null) {
      _instance = CustomLocalizations._();
    }
    return _instance;
  }
...
class _CustomLocalizationsDelegate
  ...
  Future<CustomLocalizations> load(Locale locale) {
    var object = CustomLocalizations();
    object.locale = locale;
    return new SynchronousFuture<CustomLocalizations>(object);
  }
